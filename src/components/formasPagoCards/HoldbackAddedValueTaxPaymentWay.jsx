...
const HoldbackAddedValueTaxPaymentWay = (props) => {
    ...
    return (
        <Col>
            <Form.Group className="mb-3">
                <Form.Label>Número de la retención:</Form.Label>
                <Form.Control type="text" placeholder="Ingrese el número de la retención" id="identClient" name="identClient" onKeyDown={handleKeyDownClient} />
            </Form.Group>
            <Form.Group className="mb-3">
...
export default HoldbackAddedValueTaxPaymentWay;